...
import se.sundsvall.messaging.api.validation.impl.ValidAddressConstraintValidator;

/**
 * Validates that an address has either a first name and last name, or an organization name.
 */
@Documented
@Target({
