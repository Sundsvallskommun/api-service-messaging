...
public record MessageRequest(
	...
	public record Message(
		...
		@Schema(description = "Filters", example = "{\"someAttributeName\": [\"someAttributeValue\"]}") Map<String, List<String>> filters,
		...
		public record Sender(
			...
			public record Email(
				...
				@jakarta.validation.constraints.Email @NotBlank @Schema(description = "Sender e-mail address", example = "sender@sender.se") String address,

				@Schema(description = "Reply-to e-mail address", example = "sender@sender.se") @jakarta.validation.constraints.Email String replyTo) {
			}
			...
			public record Sms(
				...
				@NotBlank @Size(max = 11) @Schema(description = "The sender of the SMS", maxLength = 11, example = "sender") String name) {
			}
		}
	}
}
