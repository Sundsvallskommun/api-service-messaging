...
class MessageResourceDigitalInvoiceFailureTests {
	...
	void shouldFailWithFileWithInvalidContentType(final String contentType) {
		// Arrange
		final var request = validRequest.withFiles(List.of(validRequest.files().get(0).withContentType(contentType)));
	...
	void shouldFailWithFileWithInvalidContent(String content) {
		// Arrange
		final var request = validRequest.withFiles(List.of(validRequest.files().get(0).withContent(content)));
	...
	void shouldFailWithFileWithInvalidName(String fileName) {
		// Arrange
		final var request = validRequest.withFiles(List.of(validRequest.files().get(0).withFilename(fileName)));
