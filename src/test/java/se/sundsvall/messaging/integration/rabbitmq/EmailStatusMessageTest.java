...
class EmailStatusMessageTest {
	...
	void isTheContractPostportalConsumes() {
		...
		final var message = new EmailStatusMessage("recipient-id", "SENT", "external-id", "detail");
	...
	void carriesNoExternalIdOnAFailure() {
		final var message = new EmailStatusMessage("recipient-id", "FAILED", null, "attempts exhausted");
